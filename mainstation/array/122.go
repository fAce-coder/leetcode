...
func maxProfit2(prices []int) int {
	...
	/*
		本题要求整个周期中，买卖多次股票所能得到的最大利润；即从周期的第0天开始，到周期的最后一天为止，买卖多次股票所能得到的最大利润
		因此将求整个周期这一大问题，拆分成求：从周期第0天开始，到某一天为止，买卖多次股票所能得到的最大利润 这一子问题，因此考虑动态规划
		1.状态（子问题）：
			从周期第0天开始，到周期第i天为止所能得到的最大利润，而第i天可能有2种状态，要么持有股票，要么没持有股票
